...
class _MainPageState extends State<MainPage>
  ...
  final List<String> titles = <String>["晨会", "夕会", "设置"];
      ...
      bottomNavigationBar: BottomNavigationBar(
        items: [
          BottomNavigationBarItem(
              icon: Icon(Icons.wb_sunny), title: Text(this.titles[0])),
          BottomNavigationBarItem(
              icon: Icon(Icons.wb_cloudy), title: Text(this.titles[1])),
          BottomNavigationBarItem(
              icon: Icon(Icons.settings), title: Text(this.titles[2])),
        ],
